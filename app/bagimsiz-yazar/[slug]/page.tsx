...
export default async function BagimsizYazarPage({
  params,
}: {
  ...
  const sosyal = yazar.sosyalMedya ?? {};
      ...
      <section className="w-full bg-[#f5f0eb] px-8 py-20 md:px-16">
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-8">
          <div className="flex-1 lg:w-[70%]">
            <h1 className="text-5xl font-bold md:text-7xl">{yazar.isim}</h1>
            {yazar.unvan && (
